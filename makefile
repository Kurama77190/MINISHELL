...
#    Updated: 2024/12/16 09:07:09 by sben-tay         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/main.c \
		...
		checker_prompt_utils.c checker_prompt_utils2.c checker_prompt_utils3.c) \
		# $(addprefix $(EXPAND), handle_expand_here_doc.c handle_expand.c expand_redir_utils.c expand_redir.c )
